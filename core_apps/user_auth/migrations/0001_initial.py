# Generated by Django 5.2.2 on 2025-06-17 15:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.UUID('91aba79b-e1e3-46ca-910b-0523b7253717'), editable=False, primary_key=True, serialize=False)),
                ('username', models.CharField(max_length=150, unique=True, verbose_name='Username')),
                ('security_question', models.CharField(choices=[('birth_city', 'What is the city where your were born? '), ('first_school_name', 'What is your first school name? '), ('favourite_sport', 'What is your favourite sport? ')], max_length=60, verbose_name='Security Question')),
                ('security_answer', models.CharField(max_length=60, verbose_name='Security Answer')),
