...
if path.isfile(local_env_file):
    load_dotenv(local_env_file) #load all environment varibles present in this file
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Finverse Bank API",
    "DESCRIPTION":"API for Finverse Bank",
    "VERSION":"1.0.0",
    ...
    "handlers":[
        {
            ...
            "rotation":"10MB", #splits the logs into a new file if size exceeds
            "retention":"30 days", #keeps log for 30days then deletes
            "compression": "zip",
        },
        {
...
LOGGING = {
    ...
    "hanlders":{"loguru": {"class":"interceptor.InterceptorHandler"}},
